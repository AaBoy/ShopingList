...
public class IskanjeArrajAdapter  extends ArrayAdapter<Artikli>{
	public static final int DIALOG_DODAJ_IZDELEK =1;
	LayoutInflater mInflater;
	GlobalneVrednosti app;
	Context vmensa=null;

	public IskanjeArrajAdapter(Context context, int textViewResourceId, List<Artikli> objects, GlobalneVrednosti app) { //Step 4.8 POPRAVI Stevec ->Rezultati
	...
	public View getView(final int position, View convertView, final ViewGroup parent) {
		...
		if(app.izbrani.length>position)
		{
